...
AMIX_TEMPLATE_HEADERS = [
    ...
    "Комментарий",
    "Оценка AI-помощника / комментарий",
...
COLUMN_ALIASES = {
    ...
    "bot_impression": {"оценка ai-помощника / комментарий", "оценка ai-помощника", "оценка работы бота", "комментарий по ai", "реакция на бота"},
