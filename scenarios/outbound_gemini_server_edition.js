...
const OPENING_GREETING_ATTENDED_TEXT =
    'Добрый день! Вы регистрировались на мебельное мероприятие Amix в марте. Меня Екатерина зовут, я AI-помощник, и меня попросили помочь обработать участников и регистрации. Можно я задам 3-4 вопроса?';
const OPENING_GREETING_NOT_ATTENDED_TEXT =
    'Добрый день! Вы регистрировались на мебельное мероприятие Amix в марте. Меня Екатерина зовут, я AI-помощник, и меня попросили помочь обработать базу участников и регистраций. Можно я задам 3-4 вопроса?';
...
Главная логика:
1. Поздоровайся и напомни контекст: человек регистрировался на мебельное мероприятие Amix в марте.
...
Не утверждай, что человек был на мероприятии или пришел на него. В стартовом контексте для всех статусов говори: «вы регистрировались на мебельное мероприятие Amix» или «вы были в базе регистраций».
