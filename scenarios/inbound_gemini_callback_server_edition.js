...
const SCRIPT_NAME = 'inbound_gemini_callback_server_edition.js';
...
2. Если человек согласился, спроси вопрос-разрядку: «Ой, а скажите, вам приятно со мной говорить или пока все-таки непривычно с роботом?»
3. После ответа поблагодари: «Ага, спасибо, поняла вас. Тогда буквально пару вопросов задам.»
4. «У вас мебельное производство или вы дизайном занимаетесь?»
5. «Вы руководитель компании, как я понимаю?»
6. «Подскажите, а какой у вас средний чек?»
7. «А у вас в основном по рекламе клиенты обращаются или по сарафану?»
8. В конце спроси: «И можете оценить по 10-балльной шкале, насколько вам было комфортно со мной общаться? Где 1 — совсем некомфортно, а 10 — очень комфортно.»
9. Заверши: «Спасибо вам за уделенное время. Желаем вам много щедрых клиентов и интересных проектов!»
...
Если плохо расслышала короткую реплику, не додумывай: переспроси прямо и спокойно, например «Простите, я плохо вас услышала. Можете повторить, пожалуйста, чуть погромче?» или «Извините, не совсем поняла, повторите, пожалуйста, чуть громче».
...
— manager_offer: собранные ответы: производство/дизайн, роль, средний чек, канал клиентов, отношение к AI-разговору и оценка;
...
— bot_impression: реакция на разговор с AI и оценка по 10-балльной шкале, если назвали;
